    ...
    # Time to configure the hand specifically into the ROI...
        ...
        if hand is not None:
            ...
            if num_imgs_taken <= 300:
                cv2.imwrite(r"/Users/lakshyakhetan/Downloads/code/train/" + str(element) + "/" +
                            str(num_imgs_taken) + '.jpg', thresholded)
                # cv2.imwrite(r"/Users/lakshyakhetan/Downloads/code/train/"+"\\" + str(num_imgs_taken) + '.jpg', thresholded)
                # cv2.imwrite(r"/Users/lakshyakhetan/Downloads/code/train/" + str(element) +
                #             str(num_imgs_taken) + '.jpg', thresholded)
            else:
                break
